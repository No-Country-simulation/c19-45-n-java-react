        ...
        <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-8 mb-8">
                ...
                <div className="text-center">
                    ...
                    <p className="text-gray-600">Siames</p>
                </div>
                <div className="text-center">
            ...
            <div>
                ...
                <div className="grid grid-cols-3 gap-4 md:gap-2">
                    <div className="w-full  h-40 md:w-60 md:h-52  rounded-lg overflow-hidden bg-gray-200 flex items-center justify-center">Foto 1</div>
                    <div className="w-full  h-40 md:w-60 md:h-52  rounded-lg overflow-hidden bg-gray-200 flex items-center justify-center">Foto 2</div>
                    <div className="w-full  h-40 md:w-60 md:h-52  rounded-lg overflow-hidden bg-gray-200 flex items-center justify-center">Foto 3</div>
                </div>
            </div>
        </div>
    );
